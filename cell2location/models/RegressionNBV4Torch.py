...
class RegressionNBV4Torch(RegressionTorchModel):
    ...
    def __init__(
        ...
        ############# Define the model ################
        self.model = RegressionNBV4TorchModule(self.n_cells, self.n_genes,
    ...
    def normalise_by_sample_scaling(self, remove_additive=True, remove_technology=True,
        ...
        """Normalise expression data by inferred sample scaling parameters, technology parameters
